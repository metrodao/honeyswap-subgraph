...
export function handleTransfer(event: Transfer): void {
  ...
  let factory = UniswapFactory.load(getFactoryAddress())
...
export function handleSync(event: Sync): void {
  ...
  let uniswap = UniswapFactory.load(getFactoryAddress())

  // reset factory liquidity by subtracting onluy tarcked liquidity
  uniswap.totalLiquidityNativeCurrency = uniswap.totalLiquidityNativeCurrency.minus(
  ...
  uniswap.totalLiquidityNativeCurrency = uniswap.totalLiquidityNativeCurrency.plus(trackedLiquidityNativeCurrency)
  uniswap.totalLiquidityUSD = uniswap.totalLiquidityNativeCurrency.times(bundle.nativeCurrencyPrice)
...
export function handleSwap(event: Swap): void {
  ...
  uniswap.totalVolumeNativeCurrency = uniswap.totalVolumeNativeCurrency.plus(trackedAmountNativeCurrency)
  ...
  let swaprDayData = updateUniswapDayData(event)
